...
<div id="{{ $id }}" x-data="{ show: @entangle($attributes->wire('model')).live }" x-show="show" x-on:close.stop="show = false" x-on:keydown.escape.window="show = false" class="fixed inset-x-0 px-4 pt-6 top-20 sm:px-0 sm:flex sm:items-top sm:justify-center" style="display: none;">
