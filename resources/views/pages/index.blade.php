...
@section('content')
    ...
    <div class="container grid px-6 mx-auto mt-5">
        ...
        <div class="flex justify-between">
            ...
            <div class="js-create ">
                 <a class="flex items-center px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="{{ route('pages.create') }}" title="Create a product">
                    Create a page
                </a>
            </div>
        </div>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @foreach ($pages as $page)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td>
                                    <img src="/image/{{ $page->image }}" width="100px">
                                </td>
                                ...
                                <td class="px-4 py-3 text-xs">
                                    {{ substr( $page->description, 0, 100 ) }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ date_format($page->created_at, 'Y m d -  h:m:s') }}
                                </td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">

                                    <form action="{{ route('pages.destroy', $page->id) }}" method="POST" class="flex gap-1">
