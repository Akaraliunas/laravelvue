...
<div class="container grid px-6 mx-auto mt-5">
    ...
    <form action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data" class="w-full overflow-hidden bg-white divide-y rounded-lg shadow-xs dark:divide-gray-700 dark:bg-gray-800 ">
        @csrf
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="px-4 py-3 form-group">
                    ...
                    <input type="text" name="title" class="block w-full mt-1 text-sm font-semibold text-gray-600 form-control dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Tsitle">
                    @error('title')
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="px-4 py-3 form-group">
                    ...
                    <input type="text" name="slug" class="block w-full mt-1 text-sm font-semibold text-gray-600 form-control dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Slug">
                    @error('slug')
                        <div class="mt-1 mb-1 alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
