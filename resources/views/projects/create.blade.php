...
<div class="container grid px-6 mx-auto mt-5">
    ...
    <form action="{{ route('projects.store') }}" method="POST" class="w-full overflow-hidden bg-white divide-y rounded-lg shadow-xs dark:divide-gray-700 dark:bg-gray-800 ">
        @csrf
