                    ...
                    <div class="grid grid-cols-1">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg font-semibold leading-7"><a href="https://laravel.com/docs" class="text-gray-900 underline dark:text-white">About me</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem temporibus facere quo corporis labore incidunt nesciunt quas autem aliquam consequatur in unde quod molestiae inventore, hic voluptatum. Quae, aliquam iusto? Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus natus vero inventore omnis cupiditate corrupti facere. Perferendis, culpa sint? Fugiat sunt enim odit recusandae praesentium, eligendi quos laborum voluptate tempora?
                                </div>
                            </div>
                        </div>
